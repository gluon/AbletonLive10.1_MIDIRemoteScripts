...
# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/SL_MkIII/elements.py
...
def create_display_color_element(h_position, v_position, name, **k):
    sysex_identifier = sysex.SET_PROPERTY_MSG_HEADER + (
     h_position, sysex.COLOR_PROPERTY_BYTE, v_position)
...
def create_selection_field(h_position, v_position):
    sysex_identifier = sysex.SET_PROPERTY_MSG_HEADER + (
     h_position, sysex.VALUE_PROPERTY_BYTE, v_position)
...
class Elements(object):
    ...
    def __init__(self, *a, **k):
        ...
        self.pads_quadratic = ButtonMatrixElement(rows=[
         ...
         pads_raw[1][4:],
         pads_raw[0][:4],
         pads_raw[1][:4]], name='Pads_Quadratic')
