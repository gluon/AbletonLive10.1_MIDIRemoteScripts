...
# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/_Komplete_Kontrol/komplete_kontrol_base.py
...
class KompleteKontrolBase(ControlSurface):
    ...
    def _create_clip_launch_background(self):
        self._clip_launch_background = BackgroundComponent(name='Background', is_enabled=False, layer=Layer(clip_launch_button=self._clip_launch_button, track_stop_button=self._track_stop_button, priority=-1))
