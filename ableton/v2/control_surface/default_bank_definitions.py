...
# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v2/control_surface/default_bank_definitions.py
   ...
   'Delay': IndexedDict((
           (
            ...
            {BANK_PARAMETERS_KEY: (
                                   ...
                                   'R Offset', 'Feedback', 'Dry/Wet')}),
           (
            'Time',
            {BANK_PARAMETERS_KEY: (
                                   use('Delay Mode').with_name('DlayMd'), 'Link', 'Ping Pong', 'L Offset',
                                   'R Offset', 'Freeze', 'Feedback', 'Dry/Wet')}),
           (
            'Filter/Mod',
            {BANK_PARAMETERS_KEY: (
                                   'Filter On', 'Filter Freq', 'Filter Width',
                                   use('Mod Freq').with_name('Filter Mod Rate'),
                                   'Filter < Mod', 'Dly < Mod', 'Feedback', 'Dry/Wet')}))), 
   'Tube': IndexedDict((
          (
           'Character',
           {BANK_PARAMETERS_KEY: (
